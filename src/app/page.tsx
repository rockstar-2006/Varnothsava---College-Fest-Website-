...
const FAQ = () => {
    ...
    const faqs = [
        ...
        { q: "Events are not visible on the Explore Events page. Why?", a: "Check if you have completed the payment, refresh the page, and ensure you have a stable internet connection.Still facing issues then reachout to any of the developers mentioned in the developers section at the top right corner where a 4 dot icon is visible." },
        ...
        { q: "How can I contact the organizers if I face issues?", a: "Check the Contact section at top right cornerwhere a 4 dot icon is visible, use the website Chatbot for assistance, or contact the specific event coordinator." },
